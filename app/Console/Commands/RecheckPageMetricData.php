...
class RecheckPageMetricData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'hourly:recheckpagemetricdata';
      ...
      while(!$pages->isEmpty()){
        ...
        if($url_collection!=""){
          ...
          if(isset($file_ids) && $file_ids!=""){
            ...
            $batch->update();
            ProcessBulkPageMyAddrAPI::dispatch($batch)->onQueue('MyAddrAPI')->delay(now()->addMinutes(2));;
          }
        }
