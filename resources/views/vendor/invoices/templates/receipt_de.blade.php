        ...
        <td class="border-0 pl-0">
            @if($invoice->status)
                <h4 class="text-uppercase cool-gray">
                    <strong style="color: green">{{ $invoice->status }}</strong>
                </h4>
            @endif
...
<table class="table">
    ...
    <tr>
        <th class="border-0 pl-0 party-header" style="padding-bottom: 0!important;" width="48.5%">
            Recipient:
        </th>
        <th class="border-0" width="3%"></th>
        <th class="border-0 pl-0 party-header" style="padding-bottom: 0!important;">
            From:
        </th>
    </tr>
    </thead>
    <tbody>
    <tr>
        <td class="px-0" style="padding-top: 0.25rem;">
...
@if($invoice->notes)
    ...
    <p style="padding-top: 50px;text-align: center"><strong>Terms & Conditions</strong><br>
        {{ $invoice->notes }}
    </p>
@endif
